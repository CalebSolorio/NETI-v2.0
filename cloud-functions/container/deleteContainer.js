...
/**
 * Assists with deleting a container type.
 *
 ...
 */
       ...
       if(size > 0) {
         ...
         for(var drug in drugs.val()) {
           ...
           for(var appearance in appearances) {
             if(appearances[appearance].container_id == id) {
               var response = {
                   status: 403,
                   message: "Drugs are still dependent on this container."
               };
  ...
  *
  * @param {String} id The id of the container type.
  * @param {Object} context Lambda function response context.
  */
